...
* `sed` - is command ko ksis specific line ko katne ke liye use karein , sed -n '5p' file ka naam, ek aur cheez hai ismein, hum is sed 's/f/tg' file name , command se chnage bhi kar sakte hain, aur bhi bahut kuch hai.
